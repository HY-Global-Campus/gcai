...
pub struct AzureMachineLearningIndexChatExtensionParameters {
    ...
    #[serde(rename = "project_resource_id")]
...
impl AzureMachineLearningIndexChatExtensionParameters {
    ...
    pub fn new(project_resource_id: String, name: String, version: String) -> AzureMachineLearningIndexChatExtensionParameters {
