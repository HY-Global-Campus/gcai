...
pub struct MongoDbChatExtensionParameters {
    ...
    pub authentication: Option<Box<models::OnYourDataUsernameAndPasswordAuthenticationOptions>>,
    ...
    pub fields_mapping: Box<models::MongoDbChatExtensionParametersFieldsMapping>,
    /// The vectorization source to use with the MongoDB chat extension.
    #[serde(rename = "embedding_dependency")]
    pub embedding_dependency: serde_json::Value,
}

impl MongoDbChatExtensionParameters {
    ...
    pub fn new(endpoint: String, collection_name: String, database_name: String, app_name: String, index_name: String, fields_mapping: models::MongoDbChatExtensionParametersFieldsMapping, embedding_dependency: serde_json::Value) -> MongoDbChatExtensionParameters {
