...
pub struct CompletionsOptions {
    ...
    pub n: Option<i32>,
    /// A value that controls the emission of log probabilities for the provided number of most likely tokens within a completions response.
...
impl CompletionsOptions {
    ...
    pub fn new(prompt: Vec<String>) -> CompletionsOptions {
        CompletionsOptions {
            prompt,
            max_tokens: None,
            temperature: None,
