...
pub struct ElasticsearchChatExtensionParameters {
    ...
    pub fields_mapping: Option<Box<models::ElasticsearchIndexFieldMappingOptions>>,
    #[serde(rename = "query_type", skip_serializing_if = "Option::is_none")]
    pub query_type: Option<models::ElasticsearchQueryType>,
...
impl ElasticsearchChatExtensionParameters {
    ...
    pub fn new(endpoint: String, index_name: String) -> ElasticsearchChatExtensionParameters {
