...
pub enum AudioTranscriptionFormat {
    #[serde(rename = "json")]
    Json,
...
impl std::fmt::Display for AudioTranscriptionFormat {
...
impl Default for AudioTranscriptionFormat {
    fn default() -> AudioTranscriptionFormat {
        Self::Json
    }
}
