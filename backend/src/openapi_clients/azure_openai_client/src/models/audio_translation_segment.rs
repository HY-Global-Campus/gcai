...
pub struct AudioTranslationSegment {
...
impl AudioTranslationSegment {
    ...
    pub fn new(id: i32, start: f32, end: f32, text: String, temperature: f32, avg_logprob: f32, compression_ratio: f32, no_speech_prob: f32, tokens: Vec<i32>, seek: i32) -> AudioTranslationSegment {
