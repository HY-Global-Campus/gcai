...
impl RealtimeServerEventResponseOutputItemAdded {
    ...
    pub fn new(event_id: String, r#type: Type, response_id: String, output_index: i32, item: models::RealtimeConversationItem) -> RealtimeServerEventResponseOutputItemAdded {
...
impl Default for Type {
    fn default() -> Type {
        Self::ResponsePeriodOutputItemPeriodAdded
    }
}
