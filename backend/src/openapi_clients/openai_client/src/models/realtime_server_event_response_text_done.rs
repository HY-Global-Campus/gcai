...
impl RealtimeServerEventResponseTextDone {
    ...
    pub fn new(event_id: String, r#type: Type, response_id: String, item_id: String, output_index: i32, content_index: i32, text: String) -> RealtimeServerEventResponseTextDone {
...
impl Default for Type {
    fn default() -> Type {
        Self::ResponsePeriodTextPeriodDone
    }
}
