...
impl RealtimeServerEventResponseAudioTranscriptDelta {
    ...
    pub fn new(event_id: String, r#type: Type, response_id: String, item_id: String, output_index: i32, content_index: i32, delta: String) -> RealtimeServerEventResponseAudioTranscriptDelta {
...
impl Default for Type {
    fn default() -> Type {
        Self::ResponsePeriodAudioTranscriptPeriodDelta
    }
}
