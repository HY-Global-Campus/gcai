...
impl CreateChatCompletionResponseChoicesInnerLogprobs {
    ...
    pub fn new(content: Option<Vec<models::ChatCompletionTokenLogprob>>, refusal: Option<Vec<models::ChatCompletionTokenLogprob>>) -> CreateChatCompletionResponseChoicesInnerLogprobs {
