...
pub async fn list_files(configuration: &configuration::Configuration, purpose: Option<&str>, limit: Option<i32>, order: Option<&str>, after: Option<&str>) -> Result<models::ListFilesResponse, Error<ListFilesError>> {
    let local_var_configuration = configuration;
